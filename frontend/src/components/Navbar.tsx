...
import { Trophy, Gauge, ShoppingCart, LogOut, User, Cpu } from 'lucide-react';
    ...
    <nav className="border-b border-white/10 bg-background/50 backdrop-blur-md sticky top-0 z-50">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group cursor-pointer">
          ...
          <span className="text-xl font-bold tracking-tighter uppercase text-white">Nitro<span className="text-primary">Dash</span></span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-400">
          ...
          <Link to="/simulator" className="hover:text-white transition-colors flex items-center gap-2 text-primary font-bold">
